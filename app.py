...
desc_temp = """ ### Loan Prediction App 
                ...
                <ul>
                    ...
                    <li>ApplicantIncome: How much borrower makes</li>
                </ul>    
                """
...
def run_ml_app():
    ...
    coApplicant_income = left.number_input("Applicant Income",min_value = 10)
    loan_amount = right.number_input("Loan Amount",min_value = 100)
    loan_amount_term = left.number_input("Loan Amount",min_value = 30, max_value = 360)
